...
namespace MoreMountains.CorgiEngine 
{
	...
	public class MultiplayerCameraController : MonoBehaviour 
	{
		...
		[MMInformation("If the camera is orthographic, you can set its min size here, and how much space around the farthest players should be kept on screen.",MoreMountains.Tools.MMInformationAttribute.InformationType.Info,false)]
		/// Minimal zoom size
		...
		[MMInformation("If the camera is perspective based, you can define here its min and max bounds.",MoreMountains.Tools.MMInformationAttribute.InformationType.Info,false)]
